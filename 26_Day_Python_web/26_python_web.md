...
```sh
kalaiyarasan@Kalaiyarasan:~/Desktop$ mkdir python_for_web
kalaiyarasan@Kalaiyarasan:~/Desktop$ cd python_for_web/
kalaiyarasan@Kalaiyarasan:~/Desktop/python_for_web$ virtualenv ve
kalaiyarasan@Kalaiyarasan:~/Desktop/python_for_web$ source venv/bin/activate
(env) kalaiyarasan@Kalaiyarasan:~/Desktop/python_for_web$ pip freeze
(env) kalaiyarasan@Kalaiyarasan:~/Desktop/python_for_web$ pip install Flask
(env) kalaiyarasan@Kalaiyarasan:~/Desktop/python_for_web$ pip freeze
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) kalaiyarasan@Kalaiyarasan:~/Desktop/python_for_web$
```
...
```sh
kalaiyarasan@Kalaiyarasan:~$ heroku login
...
Logging in... done
Logged in as kalaiyarasanm43@@gmail.com
kalaiyarasan@Kalaiyarasan:~$
```
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) kalaiyarasan@Kalaiyarasan:~/Desktop/python_for_web$ touch requirements.txt
(env) kalaiyarasan@Kalaiyarasan:~/Desktop/python_for_web$ pip freeze > requirements.txt
(env) kalaiyarasan@Kalaiyarasan:~/Desktop/python_for_web$ cat requirements.txt
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
Jinja2==2.10.3
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) kalaiyarasan@Kalaiyarasan:~/Desktop/python_for_web$ touch Procfile
(env) kalaiyarasan@Kalaiyarasan:~/Desktop/python_for_web$ ls
Procfile          env/              static/
